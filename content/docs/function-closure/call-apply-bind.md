...
`call`, `apply`, `bind` là ba method có sẵn trên *mọi* hàm (`Function.prototype`) cho phép bạn **chỉ định `this` một cách tường minh** — thay vì để JS tự suy theo call-site. Chúng giải quyết đúng vấn đề "[`this` bị mất khi tách method](/function-closure/this-keyword/)".
...
> [!WARNING]
> Nếu cần đổi `this`, hàm đó **phải là function thường**. Đừng cố `bind` một arrow function — vô tác dụng. Xem [Từ khoá this](/function-closure/this-keyword/).
